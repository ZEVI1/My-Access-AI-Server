...
namespace MS.Access.MCP.Interop
{
    public class AccessInteropService : IDisposable
    {
            ...
            try
            {
                ...
                if (_accessApplication != null)
                {
                    try
                    {
                        ...
                        catch { /* COM release exception expected during shutdown, safe to ignore */ }
        ...
        public void CreateForm(string formName)
        {
            ...
            finally
            {
                if (form != null)
                {
                    try { Marshal.ReleaseComObject(form); } catch { /* COM release exception expected during shutdown, safe to ignore */ }
                }
            }
        }
        ...
        public List<SystemTableInfo> GetSystemTables()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    try { created = reader["DateCreate"] != DBNull.Value ? Convert.ToDateTime(reader["DateCreate"]) : DateTime.MinValue; } catch (Exception ex) { FileLogger.Log($"Error parsing DateCreate: {ex.Message}"); }
                    try { updated = reader["DateUpdate"] != DBNull.Value ? Convert.ToDateTime(reader["DateUpdate"]) : DateTime.MinValue; } catch (Exception ex) { FileLogger.Log($"Error parsing DateUpdate: {ex.Message}"); }
    ...
    public static class FileLogger
    {
        ...
        static FileLogger()
        {
            ...
            catch { /* Exception in FileLogger, safely ignored */ }
